...
<div class="card-grid">
  ...
  <div class="card">
    ...
    <div class="card-content">
      <h3>Brenda Hanley</h3>
      <p>Brenda is a Senior Research Associate at the <a href="https://cwhl.vet.cornell.edu/" target="_blank">Cornell Wildlife Health Lab</a>. Her research involves adapting or inventing new computational tools to aid resource managers in analyzing their data. She is trained in geography, mathematics, statistics, and computational biology. When not doing math or stats for wildlife bios, she is outside fully engrossed by the rocks, or serving on her local search and rescue team.</p>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-content">
      <h3>Allen Herbst</h3>
      <p>Allen is a prion biologist and diagnostic biochemist at the <a href="https://www.usgs.gov/national-wildlife-health-center" target="_blank">U.S. Geological Survey’s National Wildlife Health Center</a>. The Chronic Wasting Disease (CWD) research laboratory at NWHC focuses on advancing prion detection to strengthen CWD surveillance, deepen understanding of disease transmission, and support mitigation of prion‑related threats. The laboratory’s current research priorities include: i) measuring CWD prion biochemical variation with the goal of detecting and distinguishing prion strains, ii) investigating CWD prion shedding, persistence, and environmental transmission, and iii) understanding how cervid prion protein genetic variation modifies CWD progression and pathology.</p>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-content">
      ...
      <p>Alyssa is a conservation geneticist with broad interests in developing and deploying novel molecular techniques for the protection and conservation of free-ranging wildlife. Her research focuses on untangling host-pathogen-microbiome interactions in wildlife disease, and building new noninvasive or minimally invasive methods for the study of wildlife and their pathogens. Alyssa is excited to support the mission of SOP4CWD by providing molecular expertise to help integrate genetics and genomics data into the models and uncover new insights into the best ways to combat the spread of CWD. Alyssa is a Research Associate at the <a href="https://cwhl.vet.cornell.edu/" target="_blank">Cornell Wildlife Health Lab</a> .</p>
    </div>
  </div>
  
  <div class="card">
    <div class="card-image">
      <img src="/assets/HunterKindlin.JPG" alt="Image of Hunter Kindlin">
    </div>
    <div class="card-content">
      <h3>Hunter Kindlin</h3>
      <p>Hunter is a data engineer with the <a href="https://cwhl.vet.cornell.edu/" target="_blank">Cornell Wildlife Health Lab</a>. Hunter merges professional data science experience with a passion for wildlife conservation by developing machine learning solutions and big data pipelines. He has spent over a decade volunteering with the Natural Resources Department of Letterkenny Army Depot assisting with various wildlife surveys, bird banding, running hunter check stations and collecting deer harvest data. Hunter is also a certified wildland firefighter.</p>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-content">
      <h3>Chandika Rani Ganesh Babu</h3>
      <p>Chandika is a postdoctoral fellow at the <a href="https://wildlife.cornell.edu/" target="_blank">K. Lisa Yang Center for Wildlife Health</a> who works with the <a href="https://cwhl.vet.cornell.edu/" target="_blank">Cornell Wildlife Health Lab</a> to explore how genetic and molecular mechanisms influence deer infectivity of CWD. Her work integrates genomic and transcriptomic data to identify genes and regulatory pathways that contribute to disease susceptibility. By combining DNA sequencing with gene expression analyses, she aims to uncover molecular signatures that help explain differences in infection outcomes among individuals. </p>
    </div>
  </div>
  ...
  <div class="card">
      <div class="card-image">
        <img src="/assets/JueWang.jpg" alt="image of Jue Wang">
      </div>
      <div class="card-content">
        <h3>Jue Wang</h3>
        <p>Jue is an associate professor of management science at <a href="https://smith.queensu.ca/" target="_blank">Smith School of Business</a>, Queen's University, Canada. His background is operations research and decision science. His research focuses on sequential decision making under uncertainty. He develops decision models to improve data collection and management strategies in biodiversity conservation, wildlife health, and invasive species management. Jue received his PhD in operations research from the University of Toronto, and recently spent his sabbatical year at the Cornell Johnson School of Management.</p>
      </div>
  </div>
