...
The **Hazard Risk Weights Collection** contains expert elicited information about the severity of risk posed by each known risk factor. For more details, go to the [Data Warehouse User Manual: Hazard Risk Weights Collection.](https://pages.github.coecis.cornell.edu/CWHL/CWD-Data-Warehouse/hazard-risk-weights-collection.html){target="_blank"} 
...
The **Disposal Collection** contains information about locations or facilities that dispose of carcasses, including landfills, rendering facilities, or incineration facilities. For more details, go to the [Data Warehouse User Manual: Disposal Collection.](https://pages.github.coecis.cornell.edu/CWHL/CWD-Data-Warehouse/disposal.html){target="_blank"} 
...
The **Seasonal Migration Collection** contains geospatial information about cervid movements across the year. This collection allows agencies to consider seasonal movements of hosts relative to CWD risks or hazards. For more details, go to the [Data Warehouse User Manual: Seasonal Migration Collection.](https://pages.github.coecis.cornell.edu/CWHL/CWD-Data-Warehouse/migration.html){target="_blank"} 

The **Congregation Collection** contains information about locations or facilities that congregate live cervids any time of year. For more details, go to the [Data Warehouse User Manual: Congregation Collection.](https://pages.github.coecis.cornell.edu/CWHL/CWD-Data-Warehouse/congregation.html){target="_blank"} 
